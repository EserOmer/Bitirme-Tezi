...
namespace Client.Security
{
    ...
    {
        private readonly IAuthService authService; // bizim apiye erisecek servis
        private ISessionStorageService sessionStorage; // giris yaptiktan sonra bilgilerimizi hatirlayacak paket
